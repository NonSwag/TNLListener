...
public class NMSArmorStand extends EntityArmorStand implements TNLArmorStand {
    ...
    public void setItemInMainHand(@Nullable TNLItem item) {
        super.setSlot(EnumItemSlot.MAINHAND, CraftItemStack.asNMSCopy(item != null ? item.build() : null), true);
    }

    @Override
    public void setItemInOffHand(@Nullable TNLItem item) {
        super.setSlot(EnumItemSlot.OFFHAND, CraftItemStack.asNMSCopy(item != null ? item.build() : null), true);
    }

    @Override
    public void setHelmet(@Nullable TNLItem item) {
        super.setSlot(EnumItemSlot.HEAD, CraftItemStack.asNMSCopy(item != null ? item.build() : null), true);
    }

    @Override
    public void setChestplate(@Nullable TNLItem item) {
        super.setSlot(EnumItemSlot.CHEST, CraftItemStack.asNMSCopy(item != null ? item.build() : null), true);
    }

    @Override
    public void setLeggings(@Nullable TNLItem item) {
        super.setSlot(EnumItemSlot.LEGS, CraftItemStack.asNMSCopy(item != null ? item.build() : null), true);
    }

    @Override
    public void setBoots(@Nullable TNLItem item) {
        super.setSlot(EnumItemSlot.FEET, CraftItemStack.asNMSCopy(item != null ? item.build() : null), true);
    }
