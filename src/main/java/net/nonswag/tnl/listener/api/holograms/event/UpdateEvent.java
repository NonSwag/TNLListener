...
public class UpdateEvent extends HologramEvent {
    ...
    public UpdateEvent(@Nonnull TNLPlayer player, @Nonnull Hologram hologram, @Nonnull List<TNLArmorStand> armorStands) {
        super(hologram);
        this.player = player;
