package net.nonswag.tnl.listener.v1_16_R1;

import net.nonswag.tnl.listener.NMSMain;
import net.nonswag.tnl.listener.v1_16_R1.adapter.PacketAdapter;
import net.nonswag.tnl.listener.v1_16_R1.eventListener.*;
...
public class TNLListener {
    ...
    public static void onEnable() {
        try {
            ...
            NMSMain.print("Automatically Detected net.minecraft.server.v1_16_R1",
                    "Started the listener with org.bukkit.craftukkit.v1_16_R1",
                    "Using implemented api from net.nonswag.tnl.listener.v1_16_R1");
