...
public interface TNLPlayerImpl {
    @Nullable
    Entity getVehicle();
    ...
    @Nullable
    Block getTargetBlockExact(int i, @Nonnull FluidCollisionMode fluidCollisionMode);

    @Nullable
    RayTraceResult rayTraceBlocks(double v);

    @Nullable
    RayTraceResult rayTraceBlocks(double v, @Nonnull FluidCollisionMode fluidCollisionMode);
    ...
    @Nullable
    <T> T getMemory(@Nonnull MemoryKey<T> memoryKey);

    @Nullable
    <T> void setMemory(@Nonnull MemoryKey<T> memoryKey, @Nonnull T t);
    ...
    @Nullable
    InventoryView openMerchant(@Nonnull Villager villager, boolean b);
    ...
    @Nullable
    InventoryView openMerchant(@Nonnull Merchant merchant, boolean b);
    ...
    void sendPacket(@Nonnull Packet<PacketListenerPlayOut> packet);

    void sendPackets(@Nonnull Packet<PacketListenerPlayOut>... packets);
    ...
    void setNameTagVisibility(@Nonnull ScoreboardTeamBase.EnumNameTagVisibility visibility);

    void setCollision(@Nonnull ScoreboardTeamBase.EnumTeamPush collision);
    ...
    void disguise(@Nonnull net.minecraft.server.v1_15_R1.EntityLiving entity, @Nonnull List<TNLPlayer> receivers);

    void disguise(@Nonnull net.minecraft.server.v1_15_R1.EntityLiving entity, @Nonnull TNLPlayer receiver);

    void disguise(@Nonnull net.minecraft.server.v1_15_R1.EntityLiving entity);
    ...
    void playNote(@Nonnull Location location, @Nonnull Instrument instrument, @Nonnull Note note);

    void playSound(@Nonnull Location location, @Nonnull Sound sound, float v, float v1);

    void playSound(@Nonnull Location location, @Nonnull String s, float v, float v1);

    void playSound(@Nonnull Location location, @Nonnull Sound sound, @Nonnull SoundCategory soundCategory, float v, float v1);

    void playSound(@Nonnull Location location, @Nonnull String s, @Nonnull SoundCategory soundCategory, float v, float v1);

    void stopSound(@Nonnull Sound sound);

    void stopSound(@Nonnull String s);

    void stopSound(@Nonnull Sound sound, @Nonnull SoundCategory soundCategory);

    void stopSound(@Nonnull String s, @Nonnull SoundCategory soundCategory);

    void sendBlockChange(@Nonnull Location location, @Nonnull BlockData blockData);
